...
const {isAccessorySupported, buildAccessory} = require('./accessory')
...
class ELPlatform {
  ...
  _addAccesory(address, eoj, uuid) {
    ...
    buildAccessory(hap, accessory, el, address, eoj)
